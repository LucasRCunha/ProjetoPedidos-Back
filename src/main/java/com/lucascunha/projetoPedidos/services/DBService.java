...
import com.lucascunha.projetoPedidos.domain.Estado;
import com.lucascunha.projetoPedidos.domain.ItemPedido;
import com.lucascunha.projetoPedidos.domain.Pagamento;
import com.lucascunha.projetoPedidos.domain.PagamentoComBoleto;
import com.lucascunha.projetoPedidos.domain.PagamentoComCartao;
import com.lucascunha.projetoPedidos.domain.Pedido;
import com.lucascunha.projetoPedidos.domain.Produto;
import com.lucascunha.projetoPedidos.enums.EstadoPagamento;
import com.lucascunha.projetoPedidos.enums.Perfil;
import com.lucascunha.projetoPedidos.enums.TipoCliente;
...
import com.lucascunha.projetoPedidos.repositories.EnderecoRepository;
import com.lucascunha.projetoPedidos.repositories.EstadoRepository;
import com.lucascunha.projetoPedidos.repositories.ItemPedidoRepository;
import com.lucascunha.projetoPedidos.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lucasrcunha01@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "lucas_cunha925@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
